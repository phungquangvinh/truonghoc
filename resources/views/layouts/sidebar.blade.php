    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Trang chủ giáo viên</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('giaovien')}}"><i class="fa fa-circle-o"></i> Danh sách 1</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('qlhocsinh')}}"><i class="fa fa-circle-o"></i> Danh sách</a></li>
          </ul>
        </li>
        <!-- <li>
